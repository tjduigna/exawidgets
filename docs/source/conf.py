...
from exawidgets import __version__
...
htmlhelp_basename = "exawidgetsdoc"
...
latex_documents = [(master_doc, "exawidgets.tex", "Exawidgets Documentation",
                    "Thomas J. Duignan and Alex Marchenko", "manual")]
...
man_pages = [
    (master_doc, "exawidgets", "Exawidgets Documentation",
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, "exawidgets", "Exawidgets Documentation",
   author, "Thomas J. Duignan and Alex Marchenko",
   "A bridge between ipywidgets/Backbone.js/Jupyter and third-party JavaScript libraries",
   "Copyright (c) 2015-2017, Exa Analytics Development Team")
]
